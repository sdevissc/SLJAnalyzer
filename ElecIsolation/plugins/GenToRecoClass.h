...
GenToRecoFiller::GenToRecoFiller(const TString & tag){
	...
	tree_efficiency->Branch("dr03TkSumPt",&dr03TkSumPt,"dr03TkSumPt/F");
        tree_efficiency->Branch("dr03EcalRecHitSumEt",&dr03EcalRecHitSumEt,"dr03EcalRecHitSumEt/F");
        tree_efficiency->Branch("dr03HcalTowerSumEt",&dr03HcalTowerSumEt,"dr03HcalTowerSumEt/F");
        tree_efficiency->Branch("ecalPFClusterIso",&ecalPFClusterIso,"ecalPFClusterIso/F");
        tree_efficiency->Branch("hcalPFClusterIso",&hcalPFClusterIso,"hcalPFClusterIso/F");
	tree_efficiency->Branch("pfIso",&pfIso,"pfIso/F");
        tree_efficiency->Branch("detIso",&detIso,"detIso/F");
	tree_efficiency->Branch("isoChargedHadrons",&isoChargedHadrons,"isoChargedHadrons/F");
        tree_efficiency->Branch("isoNeutralHadrons",&isoNeutralHadrons,"isoNeutralHadrons/F");
        tree_efficiency->Branch("isoPhotons",&isoPhotons,"isoPhotons/F");
        tree_efficiency->Branch("isoChargedHadFromPileup",&isoChargedHadFromPileup,"isoChargedHadFromPileup/F");
	tree_efficiency->Branch("isPF",&isPF,"isPF/I");
        tree_efficiency->Branch("ManualIsoPF",&ManualIsoPF,"ManualIsoPF/F");
}
...
void GenToRecoFiller::initGenToRecoFillerObject(){
	...
	isMatchedWithAPFElec=-0;
        ...
        PFElecPhi=-777.0;
	dr03TkSumPt=-777.0;
        dr03EcalRecHitSumEt=-777.0;
        dr03HcalTowerSumEt=-777.0;
        ecalPFClusterIso=-777.0;	
	hcalPFClusterIso=-777.0;
	pfIso=-777.0;
	detIso=-777.0;
	isoChargedHadrons=777.0;
        isoNeutralHadrons=-777.0;
        isoPhotons=-777.0;
        isoChargedHadFromPileup=-777.0;
	isPF=-777.0;
	ManualIsoPF=-777.0;
}
